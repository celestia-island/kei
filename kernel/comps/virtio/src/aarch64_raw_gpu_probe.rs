...
//
// NOTE: This hardcoded kernel-side rendering is a temporary placeholder. The
// real desktop is rendered by aris-render (Blitz + Vello CPU) in userspace
// via /dev/fb0. See ARIS_REPO / justfile build flow.
